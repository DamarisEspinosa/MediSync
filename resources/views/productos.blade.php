        ...
        <div class="w-2/3 bg-white bg-opacity-75 rounded-lg p-4">
            <table class="min-w-full bg-white border border-gray-300">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="py-2 px-4 border-b border-gray-300 whitespace-nowrap"> {{ $producto->nombreProducto }} </td>
                        <td class="py-2 px-4 border-b border-gray-300 text-center"> {{ $producto->cantidad }} </td>
                        <td class="py-2 px-4 border-b border-gray-300 text-center"> ${{ $producto->precio }} </td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
