                ...
                <form id="appointment-form" method="POST" action="{{ route('doctor.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="selected-date" name="fecha" 
                            class="mt-1 block w-full px-3 py-2 bg-transparent border-black border-2 rounded-full shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" readonly>
                    </div>
                    <div class="mb-4">
                        <label for="selected-time">Hora</label>
